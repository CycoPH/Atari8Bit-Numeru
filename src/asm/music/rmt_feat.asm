; Cut and paste the data from the line ';* --------BEGIN--------'  to the line ';* --------END--------'
; into rmt_feat.asm
;* --------BEGIN--------
;* 
FEAT_SFX		= 1
...
FEAT_INSTRSPEED		= 1
FEAT_CONSTANTSPEED		= 16		;(0 times)
FEAT_COMMAND1		= 1		;(28 times)
...
FEAT_AUDCTLMANUALSET		= 1		;(1 times)
FEAT_VOLUMEMIN		= 1		;(1 times)
FEAT_EFFECTVIBRATO		= 1		;(1 times)
FEAT_EFFECTFSHIFT		= 0		;(0 times)
;* --------END--------
; RMT4 file exported as relocatable source code
; Original size: $00d4 bytes @ $4000