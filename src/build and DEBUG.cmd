...
c:\progs\cc65\bin\cl65 --debug-info -Wl --dbgfile,"out\numeru.dbg" -Ln out/numeru.lbl --lib-path C:\progs\cc65\lib -C ./atari.cfg -t atari -T -Cl -Oirs -O -vm -v --mapfile out/numeru.map -o out\c-part.xex numeru.c generator.c asm\ataristd.s
@if %errorlevel% neq 0 goto error
...
exit /b %errorlevel%
:end
start "" "D:\Altirra\3.90\altirra64.exe" /run out\numeru.xex /debug /debugcmd:.loadsym
